...
import { setLogin, initUser } from 'actions';
import { spreadsheetId } from './common/constant';
import { authService } from './firebaseApp';
import './App.css';
import AppRouter from 'Router';
import { loginOff, loginOn } from 'actions/login';
import { loadingOff } from 'actions/loading';

function App({ dispatchLogin, dispatchLoading }) {
  ...
  return (
    <div className="App">
      ...
      {isLoading ? <Loading /> : <AppRouter isLogin={isLogin} />}
    </div>
  );
}
